$(document).ready(function() {
    ...
    for(var i=0;i<playlistData.length;i++){
        var cards = createPlaylistCard(playlistData[i],i);
        $("#playlist-wrapper").append(cards);
    }
    $("#card1").addClass("active-card");
    $("#video-player").attr("src","https://player.vimeo.com/video/190062231");
    $("#views-count").html("22500");
    $("#video-title").html("Croissants | Flour and Stone");
    ...
    $(".playlist-card").click(function(){
       ...
       $("#video-player").attr("src","https://player.vimeo.com/video/"+videoPlaySectionData[cardClickedId-1].vimeoId);
       $("#views-count").html(videoPlaySectionData[cardClickedId-1].views);
       $("#video-title").html(videoPlaySectionData[cardClickedId-1].title);
       $("#video-description").html(videoPlaySectionData[cardClickedId-1].description);
    });
});